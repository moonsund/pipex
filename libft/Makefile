...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/05/27 10:47:29 by lorlov            #+#    #+#              #
#    Updated: 2025/08/24 11:37:16 by lorlov           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c ft_memset.c ft_bzero.c \
      ...
      ft_strjoin.c ft_strtrim.c ft_split.c ft_itoa.c ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_strcmp.c\
      ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c get_next_line.c ft_lstnew.c ft_lstadd_front.c \
